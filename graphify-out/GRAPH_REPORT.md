...
## Corpus Check
- 90 files · ~138,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1120 nodes · 1835 edges · 88 communities (75 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `83878213`
...
### Community 2 - "api.py"
Cohesion: 0.11
Nodes (29): FileResponse, Response, get_catalog(), get_cert_video(), get_langs(), get_models(), get_path_video(), get_paths() (+21 more)

### Community 3 - "tracker.py"
Cohesion: 0.13
Nodes (26): Scrape the official sources and update the catalog., tracker_sync(), _ai_yaml(), _apply_snapshot_status(), fetch_text(), generate_paths(), _get_bytes(), normalise_weights() (+18 more)
...
Cohesion: 0.17
Nodes (17): _comparable_code(), _dominant_model(), GeneratorConfigError, Exception, Content generator — interchangeable backends. Backends (env TEACH_BACKEND or…, Backends sometimes wrap the whole response in a ```markdown ... ``` fence even…, Stop generation when material does not meet the pipeline.yaml floor.…, A code block reduced to the parts a translation must not touch. Code blocks are… (+9 more)

### Community 8 - "cli.py"
Cohesion: 0.08
Nodes (35): command, cert_add(), cert_list(), cert_show(), cert_snapshot(), cert_translate(), cert_video(), cert_video_script() (+27 more)
...
Cohesion: 0.14
Nodes (24): get_cert(), One certification: catalogue entry, syllabus and which topics have material., clear_topic_stale(), content_dir(), get_topic(), load(), md_path(), Path (+16 more)
...
Cohesion: 0.10
Nodes (20): Alternatives considered, Can it read what we send it? (2026-09-11, second pass), Effort, How a student uses it, How it is maintained, Is it all API?, Operating it, Phase 1.5 — closing the loop: checks that improve the page (+12 more)
...
Cohesion: 0.16
Nodes (21): live(), main(), _status_snapshot(), add_cert(), catalog_path(), list_certs(), load(), load_models() (+13 more)
...
### Community 73 - "login"
Cohesion: 0.19
Nodes (13): BaseModel, Request, login(), LoginBody, logout(), post, require_subscriber(), require_user() (+5 more)

### Community 74 - "check_versions.py"
Cohesion: 0.25
...
### Community 75 - "check_syllabus.py"
Cohesion: 0.29
...
### Community 80 - "generate_topic"
Cohesion: 0.33
Nodes (7): cert_generate(), Generate content with AI for pending/stale topics. This AUTHORS from the…, generate_cert(), generate_topic(), Generate one topic's content in one language. The lab is shared., _system(), _topic_context()

### Community 84 - "next_work.py"
Cohesion: 0.60
Nodes (4): main(), Every active certification with what it still needs, most urgent first., survey(), _topic_count()

### Community 85 - "topics_per_run"
Cohesion: 0.50
Nodes (4): main(), pending(), Maximum topics one invocation may generate. 0 means unbounded, which is…, topics_per_run()

## Knowledge Gaps
- **263 isolated node(s):** `.venv/bin/python3`, `teach-plat`, `resume-generation.sh script`, `run_milestone.sh script`, `TEACH_AGENT` (+258 more)
...
- **Why does `RejectsDamagedTranslations` connect `RejectsDamagedTranslations` to `generator.py`?**
